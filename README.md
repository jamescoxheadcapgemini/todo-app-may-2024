...
*This is a demo application for teaching Git and GitHub. It is based on the [Javascript ES6 example](https://github.com/tastejs/todomvc/tree/master/examples/javascript-es6) from [todomvc](https://github.com/tastejs/todomvc).*
